...
| Criterion | Details |
|:----------|:--------|
| **2.2.1** High or very high ASCVD risk | 10-year ASCVD risk ≥ 10% by AHA PREVENT equations [3], or established ASCVD |
| **2.2.2** Risk-enhancing factors with borderline/intermediate risk | Patients with 10-year risk 3–9.9% and one or more risk enhancers per 2026 guidelines [1] |
